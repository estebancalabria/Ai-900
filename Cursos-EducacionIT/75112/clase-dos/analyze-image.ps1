$endpoint= Read-Host "Ingrese la URL del servicio de Computer Vision"
$key= Read-Host "Ingrese la clave de suscripción del servicio de Computer Vision"
...
$img = Read-Host "Ingrese la URL de la imagen que desea analizar"
