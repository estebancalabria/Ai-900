$endpoint= Read-Host "Ingrese el endpoint del recurso de Language Services"
$key= Read-Host "Ingrese la key del recurso de language Services"
$txt = Read-Host "Ingrese el texto a Analizar"
